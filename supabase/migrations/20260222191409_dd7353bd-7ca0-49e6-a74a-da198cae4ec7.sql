...
-- Allow admins to view all shipping orders
CREATE POLICY "Admins can view all orders"
ON public.shipping_orders FOR SELECT
TO authenticated
USING (public.has_role(auth.uid(), 'admin'));

-- Allow admins to update any shipping order
CREATE POLICY "Admins can update any order"
ON public.shipping_orders FOR UPDATE
TO authenticated
USING (public.has_role(auth.uid(), 'admin'));

-- Allow admins to insert shipping orders
CREATE POLICY "Admins can insert shipping orders"
